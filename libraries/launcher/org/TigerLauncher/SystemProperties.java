package org.TigerLauncher;

import org.TigerLauncher.utils.Parameters;
...
public final class SystemProperties {
    public static void apply(Parameters params) {
        ...
        if (name != null)
            System.setProperty("org.TigerLauncher.instance.name", name);
        if (iconId != null)
            System.setProperty("org.TigerLauncher.instance.icon.id", iconId);
        if (iconPath != null)
            System.setProperty("org.TigerLauncher.instance.icon.path", iconPath);
        if (windowTitle != null)
            System.setProperty("org.TigerLauncher.window.title", windowTitle);
        if (windowDimensions != null)
            System.setProperty("org.TigerLauncher.window.dimensions", windowDimensions);
