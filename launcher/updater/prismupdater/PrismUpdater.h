...
#define Tiger_EXTERNAL_EXE
#include "FileSystem.h"

#include "GitHubRelease.h"

class TigerUpdaterApp : public QApplication {
    Q_OBJECT
   public:
    enum Status { Starting, Failed, Succeeded, Initialized, Aborted };
    TigerUpdaterApp(int& argc, char** argv);
    virtual ~TigerUpdaterApp();
   ...
   private:
    ...
    bool loadTigerVersionFromExe(const QString& exe_path);
   ...
   private:
    ...
    QString m_TigerBinaryName;
    QString m_TigerVersion;
    int m_TigerVersionMajor = -1;
    int m_TigerVersionMinor = -1;
    int m_TigerVersionPatch = -1;
    QString m_prsimVersionChannel;
    QString m_TigerGitCommit;
