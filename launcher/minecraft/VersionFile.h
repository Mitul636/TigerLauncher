...
class VersionFile : public ProblemContainer {
   ...
   public: /* data */
    /// Tiger Launcher: order hint for this version file if no explicit order is set
    int order = 0;

    /// Tiger Launcher: human readable name of this package
    QString name;

    /// Tiger Launcher: package ID of this package
    QString uid;

    /// Tiger Launcher: version of this package
    QString version;

    /// Tiger Launcher: DEPRECATED dependency on a Minecraft version
    ...
    /// Tiger Launcher: class to launch legacy Minecraft with (embed in a custom window)
    QString appletClass;

    /// Mojang: Minecraft launch arguments (may contain placeholders for variable substitution)
    QString minecraftArguments;

    /// Tiger Launcher: Additional JVM launch arguments
    ...
    /// Tiger Launcher: list of tweaker mod arguments for launchwrapper
    QStringList addTweakers;

    /// Mojang: list of libraries to add to the version
    QList<LibraryPtr> libraries;

    /// Tiger Launcher: list of maven files to put in the libraries folder, but not in classpath
    QList<LibraryPtr> mavenFiles;

    /// Tiger Launcher: list of agents to add to JVM arguments
    QList<Agent> agents;

    /// The main jar (Minecraft version library, normally)
    LibraryPtr mainJar;

    /// Tiger Launcher: list of attached traits of this version file - used to enable features
    QSet<QString> traits;

    /// Tiger Launcher: list of jar mods added to this version
    QList<LibraryPtr> jarMods;

    /// Tiger Launcher: list of mods added to this version
    QList<LibraryPtr> mods;

    /**
     * Tiger Launcher: set of packages this depends on
     * NOTE: this is shared with the meta format!!!
     */
    Meta::RequireSet m_requires;

    /**
     * Tiger Launcher: set of packages this conflicts with
     * NOTE: this is shared with the meta format!!!
     */
