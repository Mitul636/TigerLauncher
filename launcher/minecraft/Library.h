...
class Library {
   ...
   private: /* methods */
    /// the default storage prefix used by Tiger Launcher
   ...
   protected: /* data */
    ...
    /// DEPRECATED: Tiger Launcher-specific absolute URL. takes precedence over the implicit maven repo URL, if defined
    QString m_absoluteURL;

    /// Tiger Launcher extension - filename override
    QString m_filename;

    /// DEPRECATED Tiger Launcher extension - display name
    QString m_displayname;

    /**
     * Tiger Launcher-specific type hint - modifies how the library is treated
     */
    QString m_hint;

    /**
     * storage - by default the local libraries folder in Tiger Launcher, but could be elsewhere
     * Tiger Launcher specific, because of FTB.
     */
