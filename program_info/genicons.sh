...
LAUNCHER_APPID="org.TigerLauncher.TigerLauncher"
...
if command -v "inkscape" && command -v "icotool" && command -v "oxipng"; then
    ...
    svg2png ${LAUNCHER_APPID}.svg "$d/TigerLauncher_16.png" 16 16
    svg2png ${LAUNCHER_APPID}.svg "$d/TigerLauncher_24.png" 24 24
    svg2png ${LAUNCHER_APPID}.svg "$d/TigerLauncher_32.png" 32 32
    svg2png ${LAUNCHER_APPID}.svg "$d/TigerLauncher_48.png" 48 48
    svg2png ${LAUNCHER_APPID}.svg "$d/TigerLauncher_64.png" 64 64
    svg2png ${LAUNCHER_APPID}.svg "$d/TigerLauncher_128.png" 128 128
    svg2png ${LAUNCHER_APPID}.svg "$d/TigerLauncher_256.png" 256 256

    oxipng --opt max --strip all --alpha --interlace 0 "$d/TigerLauncher_"*".png"

    rm TigerLauncher.ico && icotool -o TigerLauncher.ico -c \
        "$d/TigerLauncher_256.png"  \
        "$d/TigerLauncher_128.png"  \
        "$d/TigerLauncher_64.png"   \
        "$d/TigerLauncher_48.png"   \
        "$d/TigerLauncher_32.png"   \
        "$d/TigerLauncher_24.png"   \
        "$d/TigerLauncher_16.png"
else
